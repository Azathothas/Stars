...
- [Rekketstone/pms](https://github.com/Rekketstone/pms) – pms - pack my sh*t (or software) is a minimal package manager that functions more in line with Arch's PKGBUILDS and Gentoo's ebuilds.
