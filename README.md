...
- [Zweih/qp](https://github.com/Zweih/qp) – qp - Query Packages. Query installed packages from any ecosystem on Linux and MacOS.
...
- [dmachard/DNS-collector](https://github.com/dmachard/DNS-collector) – Grab your DNS logs, spot the suspicious shit, and finally understand what's happening on your network.
...
- [Samueru-sama/simple-appimage-sandbox](https://github.com/Samueru-sama/simple-appimage-sandbox) – Tool to sandbox AppImages with bubblewrap easily
