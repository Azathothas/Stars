...
- [puutaro/CommandClick](https://github.com/puutaro/CommandClick) – "another history" browser in android: has history capture UI, active URL history by gif, Ubuntu as historical master peace  
