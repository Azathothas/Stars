...
- [logdyhq/logdy-core](https://github.com/logdyhq/logdy-core) – Log viewer, stream ANY content to web UI with autogenerated filters. Parse any format with TypeScript.
