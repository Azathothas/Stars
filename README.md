...
- [tsOhgresU/bspwm](https://github.com/tsOhgresU/bspwm) – Professional bspwm desktop environment for kali linux for hacking, of all kinds, with custom shortcuts, scripts, s4vitar configurations, among other things.
